...
export default function ContactForm() {
  return (
    <div className="relative min-h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/images/contact-us-bg.png')" }}>
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full text-center md:max-w-2xl">
        ...
        <form className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <input type="text" placeholder="Full Name" className="p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600" />
          <input type="text" placeholder="Company" className="p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600" />
          <input type="tel" placeholder="Phone*" className="p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600" required />
